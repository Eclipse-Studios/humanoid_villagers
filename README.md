...
- `@thepieslayer` and `@tyllrrrr` from my [discord server](https://discord.gg/4pYjW9btNc) for their conversation suggestions.
- `@aksiome` and `@ethanout` for their assistance on a raycast system.
- `@merak48763` for his help with Mannequins.
